...
const faqs = [
  {
    ...
    a: "Стоимость рассчитывается от 60 руб/км на весь минивэн (не на человека). Например, поездка 200 км обойдётся примерно в 12 500 рублей на всех. Цена фиксируется при заказе и не меняется.",
  },
  {
