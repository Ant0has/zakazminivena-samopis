...
const DEFAULT_METHODS: PaymentMethod[] = [
  ...
  {
    icon: Clock,
    title: "Постоплата в течение 5 рабочих дней",
...
export function PaymentMethods({
  title = "Виды оплаты",
  intro = "Принимаем все основные способы оплаты — выбирайте удобный. Для юрлиц — полный пакет документов, для постоянных клиентов — постоплата в течение 5 рабочих дней.",
