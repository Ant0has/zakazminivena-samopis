...
export const fleetModels: FleetModel[] = [
  ...
  },
  {
    ...
    description: "Пример минивэна категории «Комфорт», до 7 пассажиров без водителя. Конкретную комплектацию, детские кресла и размещение багажа подтвердим до заказа.",
    whenSuitable: [
    ...
    pricing: [
      { scenario: "Минимальный расчёт «Комфорт»", price: 3000, note: "от" },
      { scenario: "Базовая ставка; коэффициенты и округление — на странице тарифов", price: 60, note: "₽/км" },
    ],
  ...
  },
  {
    ...
    fuelConsumption: 9,
    yearRange: "2015–2021",
    features: ["До 7 пассажиров", "Кондиционер", "Тонировка", "USB-зарядки"],
    description: "Пример минивэна категории «Комфорт», до 7 пассажиров без водителя. Конкретную комплектацию, детские кресла и размещение багажа подтвердим до заказа.",
    whenSuitable: [
      { title: "Бюджетный групповой трансфер", description: "до 7 пассажиров; багаж по согласованию" },
