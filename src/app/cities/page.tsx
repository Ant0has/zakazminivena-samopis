...
export const metadata: Metadata = {
  ...
  description:
    "Заказать минивэн с водителем в городах России. Межгородние поездки и трансферы в аэропорт на комфортном минивэне 7 мест. Фиксированная цена от 60 руб/км.",
  alternates: {
