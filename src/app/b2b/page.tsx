...
const faqItems = [
  ...
  },
  {
    ...
    a: "Да, мы предлагаем индивидуальные условия и специальные тарифы при регулярных заказах. Объёмные скидки от 5% (от 50 000 ₽/мес) до 10% (от 150 000 ₽/мес). Обсудим детали при заключении договора.",
  },
];
